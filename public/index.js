...
app.get('/facts', function(req, res) {
    ...
    if(topics.hasOwnProperty(req.query.topic) && 1 < parseInt(req.query.num) < topics.chess.facts.length){
        obj.topic.facts = obj.topic.facts.slice(0, parseInt(req.query.num))
    }
